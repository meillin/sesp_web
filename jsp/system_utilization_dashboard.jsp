		...
		<div class="big-row containter">
			<div class="large-3 columns full-height">
				<div class="row height-40 panel-outer">
						<h4 class="panel-heading"><i class="cap-import colorHeading-capicons"></i><span> Import servers</span></h4>
				...
				<div class="row height-40 panel-outer">
					<h4 class="panel-heading">
						<i class="cap-export colorHeading-capicons"></i><span> Export servers</span>
					</h4>
					<div class="panel-inner">
						<div class="row cpu-container">
				...
				<div class="row height-20 panel-outer">
					<h4 class="panel-heading">
						<i class="fi-graph-pie colorHeading"></i><span> Transaction servers</span>
					</h4>
					<div class="panel-inner">
						<div class="row">
			...
			<div class="large-5 columns full-height">
				<div class="row height-50 panel-outer">
						<h4 class="panel-heading"><i class="cap-import colorHeading-capicons"></i><span> Import statistics</span></h4>
				...
				<div class="row height-50 panel-outer">
					<h4 class="panel-heading"><i class="cap-export colorHeading-capicons"></i><span> Export statistics</span></h4>
					<div class="panel-inner">
							<div class="large-6 columns">
