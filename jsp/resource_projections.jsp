							...
							<div class="row">
								...
								<div class="large-6 small-6 columns">
									...
									<div>
										...
										<a class="button tiny right" id="block-filter-button-update" onclick="javascript:processProjections()"><s:text name="webportal.resourceprojections.filters.update"/></a>
								</div>
							</div>
						</div>
					</div>
