		...
		<div id="wrapper">
			...
			<div id="main-content">
				...
				<div class="title-large-block large-block text-grey">
					<s:text name="webportal.multipoint.multipointid"/>&#32: <span id="multipoint-id" class=" text-light-grey"></span>
				</div>
				...
				<div class="small-block block retractable" id="block-location">
					...
					<div class="content-wrapper">
						<div class="content">
							<div id="block-location-map-wrapper" style="width:444px; height:203px">								
							</div>
							<div class="legend">
								<div class="address legend-block text-grey">
									<div class="legend-block-title"><s:text name="webportal.multipoint.address"/>&#32:</div>
									<div class="legend-block-content text-light-grey" id="block-location-adress"></div>
								</div>
								<div class="area legend-block text-grey">
									<div class="legend-block-title"><s:text name="webportal.multipoint.area"/>&#32:</div>
				...
				<div class="large-block block block-accordion" id="block-multipoint-information">
					<div class="block-title">
						...
						<a href="#" class="block-title-button-open-all text-blue"><s:text name="webportal.multipoint.openall"/></a>
						<a href="#" class="block-title-button-close-all text-blue"><s:text name="webportal.multipoint.closeall"/></a>
					</div>
					<div class="content-wrapper">
						<div class="content">

							<ul class="accordion">
								<li class="toggleSubMenu" id="block-multipoint-information-cases">
									<span class="accordion-title">&#149; <span class="accordion-title-name"><s:text name="webportal.multipoint.cases"/></span><span id="block-multipoint-information-cases-number" class="number"></span><div class="accordion-arrow close"></div></span>
									<ul class="subMenu">
										...
										<div class="center-wrapper">
											<a href="javascript:showmorecase();" id="block-multipoint-information-cases-link-more" class="link-more text-blue"><s:text name="webportal.multipoint.case.showmorecases"/></a>											
										</div>
									</ul>
								</li>
								<li class="toggleSubMenu" id="block-multipoint-information-deviations">									
									<span class="accordion-title">&#149; <span class="accordion-title-name"><s:text name="webportal.multipoint.deviations"/></span><span id="block-multipoint-information-deviations-number" class="number"></span><div class="accordion-arrow close"></div></span>
									<ul class="subMenu">
